...
The published `reports/sg-banks.md` is titled **"Analysis of Singapore Banks — DBS · OCBC · UOB"** and has a **fixed five-section order** (Purpose · Key links · Conclusions · Supporting Data · Appendices), top to bottom. Every rebuild must reproduce it exactly:

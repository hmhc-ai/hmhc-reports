...
*Artifact: `pipeline/sg-banks/meta/health.md` (+ `health.json`, the machine-readable mirror) — sole output of `pipeline/sg-banks/method/code/build_health.py`. Report version 2026.07.25-r2, last updated 2026-07-25.*

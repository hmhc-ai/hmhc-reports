...
> **Artifact:** `pipeline/sg-banks/data/tables.md` — sole output of `pipeline/sg-banks/method/5-script-build-tables.py` (the deterministic Build-Tables script; spec in `method/5-script-build-tables.md`). Consumed by the Build-Report step (`pipeline/sg-banks/method/6-ai-build-report.md`).
> **Provenance:** every number is a deterministic transform of reconciled `pipeline/sg-banks/data/ledger.csv` (582 data rows: 261 match · 119 single-px · 116 single-cl · 58 resolved · 17 n/d · 8 n/r · 3 text/other). Rerun `python3 pipeline/sg-banks/method/5-script-build-tables.py` to regenerate; same ledger in → same tables out.

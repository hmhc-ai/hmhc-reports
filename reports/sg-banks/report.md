...
*Scope: questions from `guides/frame.md` (6 questions, formats per its internal notes, 2026-07-24); grounded in report.md (incl. Table 6) + data/signals.md (v2026.07.25-r3). Closed-book run by Claude (CwClFable5) — the SOP-recommended non-Claude rerun remains advisable. Not investment advice.*
<!-- conclusions:end -->
